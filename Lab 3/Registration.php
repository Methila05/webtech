<?php  
 ...
 {  
      ...
      {  
           ...
           $error = "<label class='text-danger'>At least 2 words are required</label>";       
      }
      else if (!preg_match("/^[a-zA-Z-. ]*$/",$_POST["name"])) {
           $error = "<label class='text-danger'>For name only letters, period, dash and white space are allowed</label>";  
      }
      ...
      {  
           ...
           $error = "<label class='text-danger'>Enter valid email ID</label>"; 
      }
      ...
      {  
           ...
           $error = "<label class='text-danger'>For user name only numbers, letters, period and dash are allowed</label>";  
      }
      else if (strlen($_POST["userName"]) < 2){
        $error = "<label class='text-danger'>For user name at least 2 characters are needed</label>";  
      }
      ...
      {  
           ...
           $error = "<label class='text-danger'>Password must not be less than eight characters</label>";           
      }
      ...
      {  
           $error = "<label class='text-danger'>Password and confirmed password didn't match</label>";  
      } 
