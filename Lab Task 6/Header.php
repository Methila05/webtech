...
<body>
    ...
    <span style="display:inline-block; width:100%; height:5%; text-align:right">
        ...
        if (isset($_SESSION['email'])) {
            ...
            echo $_SESSION["email"];
            echo '</a> | ';
            echo "<a href='Logout.php'>Logout</a> | <a href='Add_Plane_Tickets.php'>Add tickets</a> | 
            <a href='Update_Plane_Tickets.php'>Update ticket</a>  | <a href='Delete_Plane_Tickets.php'>Delete ticket</a> |<a href='View_Add_Tickets.php'> View ticket</a>  ";
        } else {
